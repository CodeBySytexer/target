...
export const RentenzahlungsweiseSchema = z.union([
  RentenzahlungsweiseMonatlichSchema,
  RentenzahlungsweiseVierteljaehrlichSchema,
  RentenzahlungsweiseHalbjaehrlichSchema,
  RentenzahlungsweiseJaehrlichSchema,
]);
